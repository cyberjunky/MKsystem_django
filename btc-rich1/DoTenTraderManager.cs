...
namespace btc_rich1
{
    ...
    {
        private Form1 interface_;
        private bool is_english_ = false;
        ...
        public DoTenTraderManager(Form1 main_form)
        {
        ...
        {
            string url = "https://docs.google.com/spreadsheets/d/1XJH4Uo89mrBs951Mlcwrk0TcNTYL8sToiQhSgx9Hw1g/edit?usp=drivesdk";

            //HttpWebRequest httpWebRequest =
            //    (HttpWebRequest)WebRequest.Create("https://docs.google.com/spreadsheets/d/1cOKbFMH_0oKOwr6A1LBrfamYC_ZK6PoCOpDABfA31EE/edit?usp=drivesdk");
            HttpWebRequest httpWebRequest =
